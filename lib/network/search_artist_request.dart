...
class PopularArtistsRequest {
  Future<dynamic> getPopularArtistsList() async {
    ...
    print('开始');
    // 1.拼接URL
    final url = "http://ws.audioscrobbler.com/2.0/?method=geo.gettopartists&country=Korea, Republic of"
        "&limit=20&api_key=aa652ac51995d952d83d12093d25d9d9&format=json";
    // 2.发送请求
    try{
