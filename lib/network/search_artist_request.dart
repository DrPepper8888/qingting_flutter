...
class SearchArtistRequest {
  Future<dynamic> getSearchArtistResultList(artistName) async {
    var result;
    print('开始');
    // 1.拼接URL
    final url = "http://ws.audioscrobbler.com/2.0/?method=artist.search&artist=$artistName&limit=10&api_key=aa652ac51995d952d83d12093d25d9d9&format=json";
    // 2.发送请求
    try{
      ...
      if (response.statusCode == 200) {
        ...
        result = json['results']['artistmatches']['artist']; //不确定是不是这样
      } else {
        print('不太行');
        result =
